            ...
            <div class="card custom-card">
                <div class="card-header">
                    <div class="card-title">
                        @can('manage-solution-template-create')
                            <a class="btn btn-primary btn-block float-end my-2" href="{{ route('manage_solution_template.create') }}">
                                ...
                                @foreach ($solutionTemplate as $value)
                                    ...
                                    <tr>
                                        ...
                                        <td data-label="Action">
                                            @can('manage-solution-template-edit')
                                                <a class="btn btn-sm btn-icon btn-info-light rounded-circle" href="{{Route('manage_solution_template.edit',$value->id)}}"> <i class="fa fa-pencil" aria-hidden="true"></i> </a>
                                            @endcan
                                            @can('manage-solution-template-delete')
