    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card custom-card">
                ...
                <div class="card-body">
                    {!! Form::open(array('route' => 'manage_product.store','method'=>'POST','enctype'=>'multipart/form-data')) !!}
                    @csrf
                    <div class="row mt-1">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
                            <div class="form-group">
                                ...
                                {!! Form::text('opening_qty', 1, array('placeholder' => 'Opening Qty' ,'class' => 'form-control')) !!}
                                @error('opening_qty')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
