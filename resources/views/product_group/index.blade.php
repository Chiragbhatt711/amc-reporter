                ...
                <div class="card-header">
                    <div class="card-title">
                        @can('product-group-create')
                            <a class="btn btn-primary" href="{{ route('product_group.create') }}">
                                        ...
                                        @if(isset($groups) && $groups)
                                            ...
                                            @foreach ($groups as $group)
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="gridjs-td" data-column-id="Group">{{ $group->group }}</td>
                                                    <td class="gridjs-td" data-column-id="Action">
                                                        @can('product-group-edit')
                                                            <a class="btn btn-sm btn-icon btn-info-light rounded-circle" href="{{Route('product_group.edit',$group->id)}}"> <i class="fa fa-pencil" aria-hidden="true"></i> </a>
                                                        @endcan
                                                        @can('product-group-delete')
                                                            <a class="btn btn-sm btn-icon btn-secondary-light rounded-circle" onclick="deleteFunction( '{{ $group->id }}')"> <i class="fa fa-trash" aria-hidden="true"></i> </a>
                                                        @endcan
                                                    </td>
                                                </tr>
                                            @endforeach
