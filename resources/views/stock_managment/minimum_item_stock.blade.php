...
<div class="page-header d-flex align-items-center justify-content-between border-bottom mb-4">
    <h1 class="page-title">Minimum Item Stock Report</h1>
    {{-- <div>
        <ol class="breadcrumb">
                                ...
                                <table role="grid" class="gridjs-table" style="height: auto;">
                                    <thead  class="gridjs-thead">
                                        <tr>
                                            ...
                                            <th class="gridjs-th" data-column-id="Minimum Stock">Minimum Stock</th>
                                            <th class="gridjs-th" data-column-id="Stock Qty">Stock Qty</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @if(isset($mainData) && $mainData)
                                            ...
                                            @foreach ($mainData as $value)
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="gridjs-td" data-column-id="Minimum Stock">{{ $value->min_qty }}</td>
                                                    <td class="gridjs-td" data-column-id="Stock Qty">{{ $value->inward_qty - $value->outward_qty }}</td>
                                                </tr>
                                            @endforeach
                                        @endif
                                    </tbody>
